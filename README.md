...
Starting pieces supplied by the level are locked in the game and drawn in blue-grey. They participate in physics but cannot be selected, moved, rotated or removed. Player-placed pieces retain the original colours and remain editable. Saved courses store only player-placed pieces; older saves are migrated by restoring the canonical locked pieces and retaining the remaining player construction.
